...
def initDB():
    ...
    doCmd("sed -i 's/192.168.2.131/{}/g' `grep 192.168.2.131 -rl {}/*`".format(localIp,dbDir))
    doCmd("sed -i 's/db.tars.com/{}/g' `grep db.tars.com -rl {}/*`".format(localIp,dbDir))
    doCmd("sed -i 's/10.120.129.226/{}/g' `grep 10.120.129.226 -rl {}/*`".format(localIp,dbDir))
