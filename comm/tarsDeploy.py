...
def deployFrameServer():
    ...
    doCmd("sed -i 's/registry.tars.com/{}/g' `find /usr/local/app/resin/webapps/ROOT/WEB-INF/classes/ -name *.conf`".format(localIp))
    doCmd("sed -i 's/db.tars.com/{}/g' `find  /usr/local/app/resin/webapps/ROOT/WEB-INF/classes/ -name *.conf`".format(mysqlHost))
    doCmd("sed -i 's/registry.tars.com/{}/g' `find /usr/local/app/resin/webapps/ROOT/WEB-INF/classes/ -name *.properties`".format(localIp))
    doCmd("sed -i 's/db.tars.com/{}/g' `find  /usr/local/app/resin/webapps/ROOT/WEB-INF/classes/ -name *.properties`".format(mysqlHost))
